...
public class VodafoneHomePageObj {
public VodafoneHomePageObj(WebDriver driver) {
     ...
     @FindBy(how=How.XPATH, using="//div[@class='row quick-links']")
     ...
     @FindBy(how=How.XPATH, using="//label[@class='radioSelect paybill col-6 unselect']")
     public WebElement Bill_Pay_btn;
     
     @FindBy(how=How.XPATH, using="//label[@class='radioSelect recharge col-6 unselect']")

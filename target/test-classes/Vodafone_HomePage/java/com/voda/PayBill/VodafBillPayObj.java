...
public VodafBillPayObj(WebDriver driver) {
	...
	@FindBy(how=How.XPATH, using= "//*[contains(@class, \"tryPaymentAgain\") and contains(@href ,\"javascript:;\")]")
   ...
   @FindBy(how=How.XPATH, using= "//*[@id='119']")
  	public WebElement Select_wallet;
   
   @FindBy(how=How.XPATH, using= "//*[@id='327']")
 	public WebElement Ptm_PaySurely;
   
   @FindBy(how=How.XPATH, using= "//*[@id='344']")
